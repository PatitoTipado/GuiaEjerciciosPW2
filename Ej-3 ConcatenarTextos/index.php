...
<h1>Concatenador de textos</h1>
<form action="index.php" method="post">
    <ul>
        <li><label for="primerValor">ingrese un primer valor: </label><input type="text" name="primerValor" id="primerValor"></li>
        <li><label for="segundoValor">ingrese un segundo valor: </label><input type="text" name="segundoValor" id="segundoValor"></li>
...
require_once ("concatenartexto.php");

if(isset($_POST["primerValor"]) && isset($_POST["segundoValor"])){
   echo concatenador($_POST["primerValor"], $_POST["segundoValor"]);
}
